...
public class TitlesRecyclerAdapter extends RecyclerView.Adapter<TitlesRecyclerAdapter.Holder> {
    ...
    private TitlesRecyclerAdapter.OnItemClick onItemClick ;

    public void setOnItemClick (TitlesRecyclerAdapter.OnItemClick onItemClick){
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TitlesRecyclerAdapter.Holder(view);
    }
